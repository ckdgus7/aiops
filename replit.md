...
### SSF관리
- 도메인(L1)정보 관리 `/ssf/domain` (fully implemented: filter bar with ChooseButton + search, data table with sorting/pagination, 13 mock rows, create/edit/delete popups)
